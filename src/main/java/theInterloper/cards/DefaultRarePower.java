...
import theInterloper.powers.RarePower;

import static theInterloper.InterloperMod.makeCardPath;

public class DefaultRarePower extends AbstractInterloperCard {
    ...
    public static final String ID = InterloperMod.makeID("DefaultRarePower");
