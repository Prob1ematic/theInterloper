...
public class DefaultSecondMagicNumberSkill extends AbstractInterloperCard {
     ...
     * variables.ExploitDmg and cards.AbstractDefaultCard
     *
    ...
    public static final String ID = InterloperMod.makeID("DefaultSecondMagicNumberSkill");
    ...
    public DefaultSecondMagicNumberSkill() {
        ...
        secondaryM = baseSecondaryM = POISON;
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(
                new ApplyPowerAction(m, p, new PoisonPower(m, p, this.secondaryM), this.secondaryM));
