...
import theInterloper.actions.UncommonPowerAction;
import theInterloper.characters.TheInterloper;

import static theInterloper.InterloperMod.makeCardPath;

public class DefaultUncommonPower extends AbstractInterloperCard {
    ...
    public static final String ID = InterloperMod.makeID("DefaultUncommonPower");
